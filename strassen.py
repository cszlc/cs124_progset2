...
def matrix_mult(matrix_a, matrix_b):
    ...
    return result
#pads to nearest even number if odd to run strassens
...
# optimized experimentally with threshold = 105, also using simultaneous computation
def strassen(matrix_a, matrix_b):
    ...
    #simulatenously calculating p values
    ...
    #Making final matrix from parts
    ...
    #Return matrix which corresponds to original size
